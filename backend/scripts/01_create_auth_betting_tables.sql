...
CREATE TABLE IF NOT EXISTS cuotas_partidos (
  ...
  CONSTRAINT chk_cuota_equipo CHECK (
    (tipo_resultado = 'empate' AND id_equipo IS NULL) OR
    (tipo_resultado != 'empate' AND id_equipo IS NOT NULL)
  )
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
('torneo_activo_id', NULL, 'ID del torneo actualmente activo para apuestas')
