...
def display_team_data(data):
    """Muestra los datos del equipo de manera legible"""
    if not data:
    ...
    if "team_roster" in data and "data" in data["team_roster"]:
        ...
        # Mostrar como tabla
        print(tabulate(roster_df, headers='keys', tablefmt='pretty', showindex=False))
...
if __name__ == "__main__":
    # Instalar tabulate si no está instalado
    try:
        import tabulate
    except ImportError:
